...
def git_function(test_data):
    ...
    def predict_input_fn(df, batch_size = 32):#git
    ...
    return model, data, test_data

# git_function('data.txt')
...
def calculate_form(home, away, date, data,):
    home_team_last_5 = 0
    home_games = data[data['team_abbreviation_home'] == home]
    home_games_last_5 = home_games.tail(5)
    home_team_last_5 = home_games_last_5['wl_home'].sum()
    
    away_team_last_5 = 0
    away_games = data[data['team_abbreviation_away'] == away]
    away_games_last_5 = away_games.tail(5)
    away_team_last_5 = 5 - away_games_last_5['wl_home'].sum()
    
    return home_team_last_5, away_team_last_5
